...
resources: { [key=_]: {"handle": key, "component": "system", "platform": "corteza" } & schema.#PkgResource } & {
	"rbac-rule": {
		package: {
			ident: "rbac"
			import: "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/pkg/rbac"
		}
	...
	"label": {
		package: {
			ident: "labels"
			import: "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/pkg/label/types"
		}
	...
	"flag": {
		package: {
			ident: "flag"
			import: "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/pkg/flag/types"
		}
	...
	"actionlog": {
		package: {
			ident: "actionlog"
			import: "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/pkg/actionlog"
		}
	...
	"resource-activity": {
		package: {
			ident: "discovery"
			import: "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/discovery/types"
		}
