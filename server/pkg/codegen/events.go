...
func procEvents(mm ...string) (dd []*eventsDef, err error) {
	...
	const (
		importTypePathTpl = "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/%s/types"
		importAutoPathTpl = "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/%s/automation"
		importAuthPath    = "github.com/guru-admin/corteza-2023.9.8-2024.09.16/server/pkg/auth"
	)
